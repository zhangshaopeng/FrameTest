 ...
 * 本类是RSA加密类
 * 公钥加密请使用以下方法：
 * {@link #encryptDataByPublicKey(String)}.
 * 公钥解密方法：
 * {@link #decryptedToStrByPublicKey(String, PublicKey)}.
 * 私钥解密方法：
 * {@link #decryptedToStrByPrivate(String, PrivateKey)}.
 */
public class RSAUtil {
     ...
     * 获取公钥
     */
    private static PublicKey publicKey = RSAUtil.keyStrToPublicKey(KEY);
    /**
