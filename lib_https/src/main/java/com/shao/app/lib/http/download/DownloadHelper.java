package com.shao.app.lib.http.download;

import com.shao.app.lib.http.download.listener.DownloadListener;
import com.shao.app.lib.http.download.util.FileUtils;
        ...
        return new OkHttpClient.Builder().
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                return originalResponse.newBuilder()
                        .body(new ProgressRespBody(originalResponse.body(), downloadListener)).build();
            }
        }).build();
    }
}
